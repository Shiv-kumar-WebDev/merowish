							...
							<tbody>
								...
								<tr>
									...
									<td
										...
										style="width: 50px;">
										<a href="{{ route('employeeEdit', ['id' => $row->id_employee]) }}" style="color:Black;"><i data-feather="edit-2"></i></a>
										<a href="{{ route('employeeDelete', ['id' => $row->id_employee]) }}" style="color:red;"><i data-feather="trash-2"></i></a>
									</td>
								</tr>
								@endforeach
							</tbody>
