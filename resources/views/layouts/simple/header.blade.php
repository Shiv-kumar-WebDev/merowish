            ...
            <ul class="nav-menus">
                ...
                <li class="cart-nav onhover-dropdown">
                    ...
                    <ul class="cart-dropdown onhover-show-div">
                        ...
                        <li><a class="btn btn-block w-100 mb-2 btn-primary view-cart" href="{{ route('cart') }}">Go
                                to shoping bag</a><a class="btn btn-block w-100 btn-secondary view-cart"
                ...
                <li class="profile-nav onhover-dropdown p-0 me-0">
                    ...
                    document.getElementById('logout-form').submit();"><i
                                    data-feather="log-out"></i>{{ __('Logout') }}
                            </a>
