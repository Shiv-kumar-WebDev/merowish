						...
						<table class="display" id="responsive">
							...
							<tbody>
								...
								<tr>
									...
									{{-- <td>{{ $row->content }}</td> --}}
									<?php
									echo '<td class="text-truncate" style="max-width:100px;">'.$row->content.'</td>';
									?>
									<td
										class="jsgrid-cell jsgrid-control-field jsgrid-align-center"
										style="width: 50px;">
										<a href="{{ route('blogEdit', ['id' => $row->id]) }}" style="color:Black;"><i data-feather="edit-2"></i></a>
										<a href="{{ route('blogDelete', ['id' => $row->id]) }}" style="color:red;"><i data-feather="trash-2"></i></a>
									</td>
								</tr>
								@endforeach
							</tbody>
