                            ...
                            <div class="card-body">
                                <form class="theme-form" method="POST" action="{{ route('warehouseCreate') }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input value="{{ $warehouseindia[0]->product_link ?? '' }}" class="form-control"
                                    ...
                                    <div class="mb-3">
                                        <label class="col-form-label pt-0" for="shipment_notes">Additional Shipment
                                            Notes</label>
                                        <input value="{{ $warehouseindia[0]->shipment_notes ?? '' }}" class="form-control"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input value="{{ $warehouseindia[0]->weight ?? '' }}" class="form-control"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input value="{{ $warehouseindia[0]->goods_value ?? '' }}" class="form-control"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input value="{{ $warehouseindia[0]->unit_shipment ?? '' }}" class="form-control"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input @if (!isset($warehouseindia[0]->payment_method))
                                        {{ 'checked' }}
                                        @endif {{ ($warehouseindia[0]->payment_method ?? '')=='Cash On Delivery'?'checked':'' }} class="form-check-input" type="radio" name="payment_method" id="cash_on_delivery" value="Cash On Delivery" data-bs-original-title="" title="">
                                        
                                        <label class="col-form-label pt-0" for="prepaid_order">Prepaid order</label>
                                        <input {{ ($warehouseindia[0]->payment_method ?? '')=='Prepaid order'?'checked':'' }} class="form-check-input" type="radio" name="payment_method" id="prepaid_order" value="Prepaid order" data-bs-original-title="" title="">
                                        </div>
                                        
                                    </div>
                                    <div class="mb-3 mt-4">
                                        <label class="col-form-label pt-0" for="coupon_code">Coupon Discount</label>
                                        <input value="{{ $warehouseindia[0]->coupon_code ?? '' }}" class="form-control"
