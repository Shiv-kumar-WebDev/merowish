							...
							<tbody>
								...
								<tr>
									...
									<td
										...
										style="width: 50px;">
										<a href="{{ route('PincodeEdit', ['id' => $row->id]) }}" style="color:Black;"><i data-feather="edit-2"></i></a>
										<a href="{{ route('pincodeDelete', ['id' => $row->id]) }}" style="color:red;"><i data-feather="trash-2"></i></a>
									</td>
								</tr>
								@endforeach
							</tbody>
