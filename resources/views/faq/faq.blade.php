				...
				<div class="card bg-primary">
					<div class="card-body">
						<div class="media faq-widgets">
							<div class="media-body">
								<h5>Knowledgebase</h5>
								<p>{{ $faq_knowledgebase[0]->knowledgebase }}</p>
							</div>
					...
					<div class="col-xl-8 xl-60 col-lg-6 col-md-7">
						...
						<div class="card">
							<div class="card-header">
								<h5 class="mb-0">
									<button class="btn btn-link collapsed ps-0" data-bs-toggle="collapse" data-bs-target="#collapseicon{{ $row->id }}" aria-expanded="false" aria-controls="collapseicon"><i data-feather="help-circle"></i> {{ $row->question }}</button>
								</h5>
							</div>
							<div class="collapse" id="collapseicon{{ $row->id }}" aria-labelledby="collapseicon" data-bs-parent="#accordionoc">
							...
							<div class="col-lg-12">
								<div class="card card-mb-faq xs-mt-search">
									...
									<div class="card-body faq-body">
										<div class="faq-form">
											<form class="row needs-validation" novalidate="" action="{{ route('faqSearch') }}" enctype="multipart/form-data" method="post">
												@csrf
											<input class="form-control" name="text" type="text" placeholder="Search.."><i class="search-icon" data-feather="search"></i>
											<button href="{{ route('faqSearch') }}" class="btn btn-primary mt-4">Search</button>
											</form>
										</div>
									</div>
								</div>
